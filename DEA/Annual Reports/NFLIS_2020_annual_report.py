...
def pdfToText(files):
    ...
    os.chdir(r'C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020')
    remainder = glob('*.pdf')
...
# file_names = pd.read_csv("filenames_2020_ar.csv")
...
file = r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\pdfs\NFLIS-Drug-AR2020_frequentdrugsfedlabs.pdf"
# %%%
# files = [file]
# pdfToText(files)

# %%
file_txt= r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\NFLIS-Drug-AR2020_frequentdrugsfedlabs.txt"
...
# %% Table 1.1
table_1_1_raw = read_pdf(file, pages = '9', pandas_options={'header': None})
table_1_1 = table_1_1_raw[0].iloc[1:26,[0]]
...
table_1_1["data_document_id"]="1690425"
table_1_1["data_document_filename"]="NFLIS-Drug-AR2020_table1.1.pdf"
table_1_1["doc_date"]="September 2021"
table_1_1["raw_cas"]=""
...
#download as csv
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\csvs")
table_1_1.to_csv("NFLIS-Drug-AR2020_table1.1.csv", columns=["data_document_id","data_document_filename","doc_date","raw_category","raw_cas","raw_chem_name","report_funcuse","cat_code","description_cpcat","cpcat_code","component","cpcat_sourcetype"], index=False)


# %% Table 1.2


table_1_2_raw = read_pdf(file, pages = '10',area=[[129,300,461,550]], pandas_options={'header': None})
...
#Repeating values declaration 
table_1_2["data_document_id"]="1690426"
table_1_2["data_document_filename"]="NFLIS-Drug-AR2020_table1.2.pdf"
table_1_2["doc_date"]="September 2021"
table_1_2["raw_cas"]=""
...
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\csvs")
table_1_2.to_csv("NFLIS-Drug-AR2020_table1.2.csv", columns=["data_document_id","data_document_filename","doc_date","raw_category","raw_cas","raw_chem_name","report_funcuse","cat_code","description_cpcat","cpcat_code","component","cpcat_sourcetype"], index=False)


# %% Table 2.1


table_2_1_raw = read_pdf(file, pages = '17', stream = True, pandas_options={'header': None})
table_2_1 = table_2_1_raw[0].iloc[5:20,[0,1]]
...
for i,j in enumerate(table_2_1['raw_chem_name']):
    if re.search(r'\s\d', str(j)):
        new = re.split(r'\s\d', str(j),maxsplit=1)
        table_2_1['raw_chem_name'].iloc[i] = new[0]


clean = lambda dirty: ''.join(filter(string.printable.__contains__, dirty))
for j in range(0, len(table_2_1)):
    table_2_1["raw_chem_name"].iloc[j]=str(table_2_1["raw_chem_name"].iloc[j]).strip().lower()
...
#Repeating values declaration 
table_2_1["data_document_id"]="1690427"
table_2_1["data_document_filename"]="NFLIS-Drug-AR2020_table2.1.pdf"
table_2_1["doc_date"]="September 2021"
table_2_1["raw_cas"]=""
...
#download as csv
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\csvs")
table_2_1.to_csv("NFLIS-Drug-AR2020_table2.1.csv", columns=["data_document_id","data_document_filename","doc_date","raw_category","raw_cas","raw_chem_name","report_funcuse","cat_code","description_cpcat","cpcat_code","component","cpcat_sourcetype"], index=False)


# %% Table 2.2

table_2_2_raw = read_pdf(file, pages = '17', stream = True,area=[[10,300,700,400]], pandas_options={'header': None})
table_2_2 = table_2_2_raw[0].iloc[29:44,[0]]
...
for j in range(0, len(table_2_2)):
    table_2_2["raw_chem_name"].iloc[j]=str(table_2_2["raw_chem_name"].iloc[j]).strip().lower()
...
#Repeating values declaration 
table_2_2["data_document_id"]="1690428"
table_2_2["data_document_filename"]="NFLIS-Drug-AR2020_table2.2.pdf"
table_2_2["doc_date"]="September 2021"
table_2_2["raw_cas"]=""
...
#download as csv
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\csvs")
table_2_2.to_csv("NFLIS-Drug-AR2020_table2.2.csv", columns=["data_document_id","data_document_filename","doc_date","raw_category","raw_cas","raw_chem_name","report_funcuse","cat_code","description_cpcat","cpcat_code","component","cpcat_sourcetype"], index=False)
...
table_2_3 = [x.strip() for x in table_2_3]
...
for i,j in enumerate(table_2_3['raw_chem_name']):
    if re.search(r'^\d', str(j)):
        starts_w_no = re.split(r'\s(?=([a-zA-Z]))',str(j), maxsplit=1)[-1]
        table_2_3['raw_chem_name'].iloc[i] = starts_w_no
for i,j in enumerate(table_2_3['raw_chem_name']):
    new_string = re.split(r'\s\d{1,3}', str(j), maxsplit = 1)[0]
    newer_string = re.split(r'\s', new_string)[-1]
    table_2_3['raw_chem_name'].iloc[i] = newer_string
...
#Repeating values declaration 
table_2_3["data_document_id"]="1690429"
table_2_3["data_document_filename"]="NFLIS-Drug-AR2020_table2.3.pdf"
table_2_3["doc_date"]="September 2021"
table_2_3["raw_cas"]=""
...
#download as csv
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\csvs")
table_2_3.to_csv("NFLIS-Drug-AR2020_table2.3.csv", columns=["data_document_id","data_document_filename","doc_date","raw_category","raw_cas","raw_chem_name","report_funcuse","cat_code","description_cpcat","cpcat_code","component","cpcat_sourcetype"], index=False)
...
table_2_4 = clean_lines[(start+1):stop]
...
#Repeating values declaration 
table_2_4["data_document_id"]="1690430"
table_2_4["data_document_filename"]="NFLIS-Drug-AR2020_table2.4.pdf"
table_2_4["doc_date"]="September 2021"
table_2_4["raw_cas"]=""
table_2_4["component"]=""
...
#download as csv
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\csvs")
table_2_4.to_csv("NFLIS-Drug-AR2020_table2.4.csv", columns=["data_document_id","data_document_filename","doc_date","raw_category","raw_cas","raw_chem_name","report_funcuse","cat_code","description_cpcat","cpcat_code","component","cpcat_sourcetype"], index=False)


# %% Table 2.5

table_2_5_raw = read_pdf(file, pages = '20', stream = True,area=[[10,300,700,400]], pandas_options={'header': None})
table_2_5 = table_2_5_raw[0].iloc[4:19,[0]]
...
#Repeating values declaration 
table_2_5["data_document_id"]="1690431"
table_2_5["data_document_filename"]="NFLIS-Drug-AR2020_table2.5.pdf"
table_2_5["doc_date"]="September 2021"
table_2_5["raw_cas"]=""
...
#download as csv
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\csvs")
table_2_5.to_csv("NFLIS-Drug-AR2020_table2.5.csv", columns=["data_document_id","data_document_filename","doc_date","raw_category","raw_cas","raw_chem_name","report_funcuse","cat_code","description_cpcat","cpcat_code","component","cpcat_sourcetype"], index=False)
...
for i,j in enumerate(clean_lines):
    if 'methamphetamine 14,269' in str(j):
        start = i
        break
...
most_freq_by_lab = most_freq_by_lab.dropna(how = 'all', axis = 0)
...
for j in range(0, len(most_freq_by_lab)):
    most_freq_by_lab["raw_chem_name"].iloc[j]=str(most_freq_by_lab["raw_chem_name"].iloc[j]).strip().lower()
...
#Repeating values declaration 
most_freq_by_lab["data_document_id"]="1690424"
most_freq_by_lab["data_document_filename"]="NFLIS-Drug-AR2020_frequentdrugsfedlabs.pdf"
most_freq_by_lab["doc_date"]="September 2021"
...
#download as csv
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020\csvs")
most_freq_by_lab.to_csv("NFLIS-Drug-AR2020_frequentdrugsfedlabs.csv", columns=["data_document_id","data_document_filename","doc_date","raw_category","raw_cas","raw_chem_name","report_funcuse","cat_code","description_cpcat","cpcat_code","component","cpcat_sourcetype"], index=False)
...
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\DEA\annual reports\2020")
extract_df.to_csv("nflis_annual_report_2020_ext.csv", index=False)
