...
os.chdir(r'C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Cleaning Scripts\Shield Industries')
file = 'shield_raw_comp_records.csv' #Name of raw extracted records file
