...
# os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\FDA\CDER Drug and Biologic Approvals\2021")
...
file = r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\FDA\CDER Drug and Biologic Approvals\2021\2021.pdf"
...
for i,table in enumerate(tables):
    ...
    if i < 4 : #New Drug Approvals
        ...
        prodID.extend(['1690601']*len(df))
        templateName.extend(['cder_drug_and_biological_approvals_2021_nda.pdf']*len(df))
        components.extend(['']*len(df))
    else: #Table 7
        chemName.extend(df.iloc[:,2])
        prodID.extend(['1690602']*len(df))
        templateName.extend(['cder_drug_and_biological_approvals_2021_bla.pdf']*len(df))
        components.extend(['']*len(df))
...
os.chdir(r"C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Extraction Scripts\FDA\CDER Drug and Biologic Approvals\2021")
df_drop.to_csv(r'2021_cder_drug_approvals_ext.csv',index=False, header=True, date_format=None)
