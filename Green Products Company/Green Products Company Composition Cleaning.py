...
os.chdir(r'C:\Users\mmetcalf\Documents and Scripts\Green Products Company\Green Products Company Composition Cleaning')
df = pd.read_csv('Factotum_Green_Products_Company_SDS_raw_extracted_records_20240129.csv')
...
df.to_csv('GPCCC.csv', index=False)
# %%
