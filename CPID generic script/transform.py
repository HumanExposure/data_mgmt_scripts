...
if __name__ == '__main__':
    # file locations
    folder = r'C:/Users/alarger/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/CPID/generic_script/scripts/output'
    chem_file = r'chemical_data_2021-12-22_16-52-37.csv'
    info_file = r'file_info_2021-12-22_16-52-37.csv'
    template_file = r'CPID_(M)SDS_unextracted_documents.csv'
    documents_file = r'cpid_msds_documents_20220105.csv'
