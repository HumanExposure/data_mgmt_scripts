# -*- coding: utf-8 -*-
"""
Created on Thu Jun  6 13:37:27 2019

@author: ALarger

Cal Pesticide Residues 1994
"""
...
casN = ['']*nIngredients
prodID = [1359542]*nIngredients
templateName = ['Cal_Pesticide_Residues_1994_orig.pdf']*nIngredients
    
df = pd.DataFrame({'data_document_id':prodID, 'data_document_filename':templateName, 'doc_date':msdsDate, 'raw_category':recUse, 'raw_cas':casN, 'raw_chem_name':chemName, 'cat_code':catCode, 'description_cpcat': descrip, 'cpcat_code':code, 'cpcat_sourcetype':sourceType})
df=df.drop_duplicates()
df.to_csv(r'L:\Lab\HEM\ALarger\Actor Automated Extraction\California\Cal Pesticide Residues\Cal Pest Residues 1994.csv',index=False, header=True)