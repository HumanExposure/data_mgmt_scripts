**apiMakeProductsGeneric.py** reads in a CSV of product data and folder of corresponding product images, and creates products through the Factotum API. Python 3.7
