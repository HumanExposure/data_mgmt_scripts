...
os.chdir(r'C:\Users\mmetcalf\Documents and Scripts\Carboline')
df = pd.read_csv('Factotum_Carboline_SDS_raw_extracted_records_20240523.csv')
...
df.to_csv('Carboline_Cleaned_Data.csv', index=False)
