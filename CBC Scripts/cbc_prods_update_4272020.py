...
text_file="CBC COVID19 Product List 4_27_2020.txt"#downloaded pdf from https://www.americanchemistry.com/Novel-Coronavirus-Fighting-Products-List.pdf?mod=article_inline and converted it to a text file for parsing with XpdfReader application
...
#write d to csv
cbc_prods.to_csv("cbc_covid19_products_list_updated_4272020.csv", index=False)

#read in last df of products and registration numbers
cbc_prods_old=pd.read_csv("cbc_covid19_products_list.csv", dtype=str)
...
#only merge in new prods for the April 3rd pull of List N which already had the products from the 3-27-2020 CBC list
...
prod_temp_apr3.to_csv("new_cbc_prods_04272020_for_listN_04032020.csv", index=False)
...
prod_temp_apr10=prod_temp_apr10.loc[prod_temp_apr10.sets.isin(list(cbc_prods.sets))]
prod_temp_apr10=prod_temp_apr10.merge(cbc_prods, on="sets", how="left")
...
prod_temp_apr10.to_csv("all_cbc_prods_04272020_for_listN_04102020.csv", index=False)
...
prod_temp_apr17=prod_temp_apr17.loc[prod_temp_apr17.sets.isin(list(cbc_prods.sets))]
prod_temp_apr17=prod_temp_apr17.merge(cbc_prods, on="sets", how="left")
...
prod_temp_apr17.to_csv("all_cbc_prods_04272020_for_listN_04172020.csv", index=False)
...
prod_temp_apr24=prod_temp_apr24.loc[prod_temp_apr24.sets.isin(list(cbc_prods.sets))]
prod_temp_apr24=prod_temp_apr24.merge(cbc_prods, on="sets", how="left")
...
prod_temp_apr24.to_csv("all_cbc_prods_04272020_for_listN_04242020.csv", index=False)
