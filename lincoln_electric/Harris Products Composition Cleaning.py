...
os.chdir(r'C:\Users\mmetcalf\Documents and Scripts\Harris Products\Composition Cleaning')
df = pd.read_csv('Factotum_Harris_Products_Group_SDS_raw_extracted_records_20240130.csv')
...
df.to_csv('Harris_Products_Cleaned_Data.csv', index=False)
