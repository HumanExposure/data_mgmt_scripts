...
os.chdir(r'C:/Users/alarger/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/Lincoln Electric/lincoln electric')
...
for file in fileList:
    ...
    template = csv.reader(open(r'Factotum_Lincoln_Electric_SDS_documents_20231114.csv')) #Get factotum document ids
    ...
    if ID in ['1683282']: continue #different format
...
df.to_csv(r'lincoln electric extracted text.csv',index=False, header=True)
