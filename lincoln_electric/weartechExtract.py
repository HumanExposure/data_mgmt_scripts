...
os.chdir(r'C:/Users/alarger/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/Lincoln Electric/weartech')
...
for file in fileList:
    ...
    template = csv.reader(open(r'Factotum_Weartech_International_SDS_documents_20231108.csv')) #Get factotum document ids
...
df.to_csv(r'weartech extracted text.csv',index=False, header=True)
