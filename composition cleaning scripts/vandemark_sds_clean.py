...
raw_data=pd.read_csv("vandemark_sds_raw_extracted_records.csv", usecols=["ExtractedChemical_id","raw_min_comp","raw_central_comp","raw_max_comp","unit_type__title"], dtype="str")
raw_data=raw_data.loc[raw_data.unit_type__title=="percent"]
raw_data=raw_data.fillna("")

split_data=raw_data.copy()
split_data.loc[split_data.raw_central_comp.str.contains(">"), ["raw_max_comp"]]="100"
split_data.loc[split_data.raw_central_comp.str.contains(">"), ["raw_min_comp"]]=split_data.raw_central_comp.str.replace(">","")
split_data.loc[split_data.raw_central_comp.str.contains(">"), ["raw_central_comp"]]=""

split_data.raw_min_comp=split_data.raw_min_comp.str.replace(" ","").str.replace(",",".")
split_data.raw_central_comp=split_data.raw_central_comp.str.replace(" ","")
split_data.raw_min_comp=split_data.raw_min_comp.str.replace(" ","")
...
clean_data.to_csv("vandemark_sds_cleaned.csv", index=False)
