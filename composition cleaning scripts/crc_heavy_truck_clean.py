...
raw_data=pd.read_csv("crc_heavy_truck_raw_extracted_records.csv", usecols=["ExtractedChemical_id","raw_min_comp","raw_central_comp","raw_max_comp","unit_type__title"], dtype=str)
...
#split data in the form ">=x" and ">x" in the raw_central_comp field into "x" in raw_min_comp and "100" in raw_max_comp
...
clean_data.to_csv("crc_heavy_truck_cleaned.csv", index=False)
