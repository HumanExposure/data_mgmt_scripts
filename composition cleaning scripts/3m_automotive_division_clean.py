...
raw_data=pd.read_csv("3m_automotive_division_raw_extracted_records.csv", usecols=["ExtractedChemical_id","raw_min_comp","raw_central_comp","raw_max_comp","unit_type__title"], dtype=str)
...
raw_data.loc[raw_data["raw_max_comp"].str.contains("<"), ["raw_min_comp"]]="0"
raw_data.loc[raw_data["raw_max_comp"].str.contains("<"), ["raw_max_comp"]]=raw_data["raw_max_comp"].str.strip("<")
...
clean_data.to_csv("3m_automotive_division_cleaned.csv", index=False)
