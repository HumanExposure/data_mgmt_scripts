...
raw_data=pd.read_csv("3m_automotive_division_raw_extracted_records.csv", usecols=["ExtractedChemical_id","raw_min_comp","raw_central_comp","raw_max_comp","unit_type__title"])
...
split_data=split_data.loc[split_data.central_wf_analysis.str.contains("[A-za-z]")==False]
