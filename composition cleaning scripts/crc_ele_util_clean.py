...
raw_data=pd.read_csv("crc_electrical__utility_raw_extracted_records.csv", usecols=["ExtractedChemical_id","raw_min_comp","raw_central_comp","raw_max_comp","unit_type__title"], dtype=str)
...
clean_data.to_csv("crc_ele_util_cleaned.csv", index=False)
