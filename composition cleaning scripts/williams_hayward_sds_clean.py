...
raw_data=pd.read_csv("williams_hayward_protective_coatings_sds_raw_extracted_records.csv", usecols=["ExtractedChemical_id","raw_min_comp","raw_central_comp","raw_max_comp","unit_type__title"], dtype="str")
raw_data=raw_data.loc[raw_data.unit_type__title=="percent"]
raw_data=raw_data.fillna("")

split_data=raw_data
split_data.loc[split_data.raw_central_comp.str.contains("<"), ["raw_max_comp"]]="1"
...
clean_data.to_csv("williams_hayward_protective_coatings_sds_cleaned.csv", index=False)
