...
raw_data=pd.read_csv("epa_list_n_-_june_5_2020_raw_extracted_records.csv", usecols=["ExtractedChemical_id","raw_min_comp","raw_central_comp","raw_max_comp","unit_type"], dtype=str)
...
clean_data=split_data.copy()
clean_data.to_csv("list_n_june5_2020_cleaned.csv", index=False)
...
raw_data=pd.read_csv("epa_list_n_-_june_19_2020_raw_extracted_records.csv", usecols=["ExtractedChemical_id","raw_min_comp","raw_central_comp","raw_max_comp","unit_type"], dtype=str)
raw_data=raw_data.loc[raw_data.unit_type=="percent"]
raw_data=raw_data.fillna("")
split_data=raw_data.rename(columns={"raw_min_comp":"lower_wf_analysis","raw_central_comp":"central_wf_analysis","raw_max_comp":"upper_wf_analysis"})
split_data=split_data[["ExtractedChemical_id","lower_wf_analysis","central_wf_analysis","upper_wf_analysis"]]
...
clean_data=split_data.copy()
clean_data.to_csv("list_n_june19_2020_cleaned.csv", index=False)
