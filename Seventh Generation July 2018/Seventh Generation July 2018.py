                ...
                for line in ifile:
                    ...
                    for i in list2:
                        ...
                        try:
                            ...
                            ID = ''
                            template = csv.reader(open(r'C:\Users\alarger\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Seventh_Generation_-_July_2018_extract_template.csv'))
