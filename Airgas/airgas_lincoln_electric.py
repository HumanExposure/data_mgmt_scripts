...
for file in fileList:
    ...
    if 'lincoln' not in prodtitle: continue #only extract lincoln electric documents
...
df.to_csv(r'C:/Users/alarger/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/Airgas/Hard/airgas lincoln electric extracted text.csv',index=False, header=True)
