...
def clean_row(x):
    ...
    if x['ci_color'] != '':
        xnew['name'] = x['name'] + ' (CI ' + str(x['ci_color']) + ')'
...
def get_name_type(fname_list, df_docs):
    ...
    print(len(pd.unique(list(val_clean.values()))))
    print(len(val_clean))
...
if __name__ == '__main__':
    # file locations
    folder = r'C:/Users/alarger/OneDrive - Environmental Protection Agency (EPA)/Profile/Documents/Airgas/Hard/generic_script/scripts/output'
    chem_file = r'chemical_data_2023-09-29_14-01-53.csv'
    info_file = r'file_info_2023-09-29_14-01-53.csv'
    template_file = r'Factotum_Airgas_HardGoods_unextracted_documents_20230929.csv'
    documents_file = r'Factotum_Airgas_HardGoods_documents_20230929.csv'
