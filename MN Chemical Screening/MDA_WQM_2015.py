...
#Extract chemicals detected in surface water MDA WQM 2015 Table 1
table_1_sw=read_pdf("MDA_2015_WQMReport.pdf", pages="21-24", lattice=True, pandas_options={"usecols":[0,1,2], "names":["raw_chem_name","report_funcuse","sw_detect"], "skiprows": lambda x: x<4 or x>189})
...
table_1_sw["data_document_id"]="1496311"
table_1_sw["data_document_filename"]="MDA_2015_WQMReport_a.pdf"
table_1_sw["doc_date"]="June 2016"
...
table_1_sw.to_csv("MDA_2015_WQM_SW.csv", index=False)

#Extract chemicals detected in groundwater MDA WQM 2015 Table 1
table_1_gw=read_pdf("MDA_2015_WQMReport.pdf", pages="21-24", lattice=True, pandas_options={"usecols":[0,1,3], "names":["raw_chem_name","report_funcuse","gw_detect"], "skiprows": lambda x: x<4 or x>189})
...
table_1_gw["data_document_id"]="1496312"
table_1_gw["data_document_filename"]="MDA_2015_WQMReport_b.pdf"
table_1_gw["doc_date"]="June 2016"
...
table_1_gw.to_csv("MDA_2015_WQM_GW.csv", index=False)
