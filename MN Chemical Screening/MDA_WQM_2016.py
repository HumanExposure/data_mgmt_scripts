...
#Extract chemicals detected in surface water MDA WQM 2016 Table 1
table_1_sw=read_pdf("MDA_2016_WQMReport.pdf", pages="26-29", lattice=True, pandas_options={"usecols":[0,1,2], "names":["raw_chem_name","report_funcuse","sw_detect"], "skiprows": lambda x: x<6 or x>198})
...
table_1_sw["data_document_id"]="1496313"
table_1_sw["data_document_filename"]="MDA_2016_WQMReport_a.pdf"
table_1_sw["doc_date"]="July 2017"
...
table_1_sw.to_csv("MDA_2016_WQM_SW.csv", index=False)

#Extract chemicals detected in groundwater MDA WQM 2016 Table 1
table_1_gw=read_pdf("MDA_2016_WQMReport.pdf", pages="26-29", lattice=True, pandas_options={"usecols":[0,1,3], "names":["raw_chem_name","report_funcuse","gw_detect"], "skiprows": lambda x: x<6 or x>198})
...
table_1_gw["data_document_id"]="1496314"
table_1_gw["data_document_filename"]="MDA_2016_WQMReport_b.pdf"
table_1_gw["doc_date"]="July 2017"
...
table_1_gw.to_csv("MDA_2016_WQM_GW.csv", index=False)
