...
#Table 1.5
temp=read_pdf("document_1374394.pdf", pages="22,23", lattice=True, pandas_options={'header': None})
...
table_1_5["data_document_id"]="1374394"
...
#Table 2.2
table_2_2=read_pdf("document_1374395.pdf", pages="26", lattice=True, pandas_options={'header': None})
...
table_2_2["data_document_id"]="1374395"
...
#Table 2.4
table_2_4=read_pdf("document_1374396.pdf", pages="28,29", lattice=True, pandas_options={'header': None})
...
table_2_4["data_document_id"]="1374396"
...
#Table 3.2
tables=read_pdf("document_1374397.pdf", pages="31,32", lattice=True, multiple_tables=True, pandas_options={'header': None})
...
table_3_2["data_document_id"]="1374397"
...
#Table 3.4
table_3_4=read_pdf("document_1374398.pdf", pages="33", lattice=True, pandas_options={'header': None})
...
table_3_4["data_document_id"]="1374398"
...
sec_4=read_pdf("document_1374399.pdf", pages="35-37", lattice=True, pandas_options={'header': None})
...
sec_4["data_document_id"]="1374399"
