...
#Table 18
tables=read_pdf("document_1372224.pdf", pages="38", lattice=True, multiple_tables=True, pandas_options={'header': None})
table_18=tables[1]
...
table_18["data_document_id"]="1372224"
...
#Table 20
tables=read_pdf("document_1372225.pdf", pages="39", lattice=True, multiple_tables=True, pandas_options={'header': None})
table_20=tables[2]
...
table_20["data_document_id"]="1372225"
...
#Table 21
tables=read_pdf("document_1372226.pdf", pages="39", lattice=True, multiple_tables=True, pandas_options={'header': None})
table_21=tables[3]
...
table_21["data_document_id"]="1372226"
...
#Table 22
tables=read_pdf("document_1372227.pdf", pages="44", lattice=True, multiple_tables=True, pandas_options={'header': None})
table_22=tables[0]
...
table_22["data_document_id"]="1372227"
...
#Table 23
tables=read_pdf("document_1372228.pdf", pages="44,45", lattice=True, multiple_tables=True, pandas_options={'header': None})
...
table_23["data_document_id"]="1372228"
...
#Table 24
tables=read_pdf("document_1372229.pdf", pages="44,45", lattice=True, multiple_tables=True, pandas_options={'header': None})
table_24=tables[3]
...
table_24["data_document_id"]="1372229"
...
#Table 25
tables=read_pdf("document_1372230.pdf", pages="44,45", lattice=True, multiple_tables=True, pandas_options={'header': None})
...
table_25["data_document_id"]="1372230"
...
#Table 26
tables=read_pdf("document_1372231.pdf", pages="45", lattice=True, multiple_tables=True, pandas_options={'header': None})
table_26=tables[3]
...
table_26["data_document_id"]="1372231"
...
#Table 28
tables=read_pdf("document_1372232.pdf", pages="47", lattice=True, multiple_tables=True, pandas_options={'header': None})
table_28=tables[0]
...
table_28["data_document_id"]="1372232"
...
#Table 29
tables=read_pdf("document_1372233.pdf", pages="47,48", lattice=True, multiple_tables=True, pandas_options={'header': None})
...
table_29["data_document_id"]="1372233"
