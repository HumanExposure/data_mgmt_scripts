...
tables=read_pdf("document_1372148.pdf", pages="31,32", multiple_tables= True, lattice=True, pandas_options={'header': None})
...
table_2_3["data_document_id"]="1372148"
...
tables=read_pdf("document_1372149.pdf", pages="33", multiple_tables= True, lattice=True, pandas_options={'header': None})
table_2_5=tables[1]
...
table_2_5["data_document_id"]="1372149"
...
tables=read_pdf("document_1372150.pdf", pages="33", multiple_tables= True, lattice=True, pandas_options={'header': None})
table_2_6=tables[2]
...
table_2_6["data_document_id"]="1372150"
...
tables=read_pdf("document_1372151.pdf", pages="34", multiple_tables= True, lattice=True, pandas_options={'header': None})
...
table_2_7["data_document_id"]="1372151"
...
tables=read_pdf("document_1372152.pdf", pages="34", multiple_tables= True, lattice=True, pandas_options={'header': None})
table_2_8=tables[2]
...
table_2_8["data_document_id"]="1372152"
