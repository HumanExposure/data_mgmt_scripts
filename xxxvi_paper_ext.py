...
# %%
os.chdir(r'C:\Users\CLUTZ01\OneDrive - Environmental Protection Agency (EPA)\Profile\Documents\Projects\Manual Extractions\BFR reccomendations\XXXVI-Paper')
...
refining_agents = data[data['divination'].str.contains('refining', case=False)].iloc[:,[0,1]]

dfs = {'raw_materials': raw_materials, 'production_aids' : production_aids, 'refining_agents': refining_agents}
