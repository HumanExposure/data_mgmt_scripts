...
os.chdir(r'C:\Users\mmetcalf\Documents and Scripts\BP Air')
df = pd.read_csv('Factotum_BP_Air_(2024)_raw_extracted_records_20240715.csv')
...
df.to_csv('BP_Air_Cleaned.csv', index=False)
