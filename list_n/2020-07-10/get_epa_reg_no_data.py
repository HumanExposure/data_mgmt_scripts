...
def read_files(input_file, old_list, date, old_date, reg_no_col, date_col):
    ...
    if old_list is None or old_date is None:
        return df
...
if __name__ == '__main__':
    ...
    input_file = os.path.join(
        'documents', date, 'List N Disinfectants for Use Against SARS-CoV-2 ' +
        '(COVID-19)  Pesticide Registration  US EPA.csv')
    old_list = os.path.join(
        'documents', old_date, 'List N Disinfectants for Use Against' +
        ' SARS-CoV-2 (COVID-19)  Pesticide Registration  US EPA.csv')
