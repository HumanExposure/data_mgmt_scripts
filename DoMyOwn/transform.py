...
if __name__ == '__main__':
    # file locations
    folder = r"C:\Users\mmetcalf\Documents and Scripts\DoMyOwn\Scripts\output"
    chem_file = r"C:\Users\mmetcalf\Documents and Scripts\DoMyOwn\Scripts\output\chemical_data_2024-04-02_14-12-36.csv"
    info_file = r"C:\Users\mmetcalf\Documents and Scripts\DoMyOwn\Scripts\output\file_info_2024-04-02_14-12-36.csv"
    template_file = r"C:\Users\mmetcalf\Documents and Scripts\DoMyOwn\Factotum_DoMyOwn_SDS_Sheets_unextracted_documents_20240327.csv"
    documents_file = r"C:\Users\mmetcalf\Documents and Scripts\DoMyOwn\Factotum_DoMyOwn_SDS_Sheets_documents_20240402.csv"
    ...
    # save files
    chem_file_name = os.path.basename(chem_file)
    info_file_name = os.path.basename(info_file)

    df_all.to_csv(os.path.join(folder, 'formatted_' + chem_file_name), index=False)
    df_info_new.to_csv(os.path.join(folder, 'formatted_' + info_file_name),
                       index=False)
    ...
    for n, i in enumerate(all_split):
        ...
        df_split.to_csv(os.path.join(
            split_path, 'split' + str(n) + '_' + chem_file_name), index=False)
