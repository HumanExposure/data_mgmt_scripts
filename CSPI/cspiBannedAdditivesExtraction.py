...
os.chdir(path)   
url = 'https://www.cspinet.org/banned-food-additives'
...
chemList = driver.find_elements('xpath','/html/body/div[1]/main/article/div[2]/article/div/div[1]/div[2]/div[4]/table/tbody/tr/td[1]/span/span[2]/span')
funcList = driver.find_elements('xpath','/html/body/div[1]/main/article/div[2]/article/div/div[1]/div[2]/div[4]/table/tbody/tr/td[3]/span/span')
...
n = len(chemList)
idList= [1797194]*n
filenameList = ['CSPI Banned Additives.pdf']*n
dateList = ['']*n
categoryList = ['Banned Food Additives']*n
casList = ['']*n
# chemList = ['']*n
# funcList = ['']*n
catcodeList = ['']*n
...
df.to_csv('cspi banned additives.csv',index=False, header=True, encoding = 'utf8')
